<h2># Research</h2>
<p>I found python a powerful language. According to my research, it can be used for Machine Learning, Deep Learning and using Internet of things, etc.
Including this, I am specifically interested in there are three Frame Work which allow for making web site easier.</p>
<ul>
    <li>-Django</li>
    <li>-Flask</li>
    <li>-Streamlit</li>
...
<p> submit_btn= st.form_submit_button('Send')
 ...
 <p>I do not understand that I can not deploy financial data on this cloud service.I success to show my financial data graph on local environment However I failed to deploy on this cloud service.</p>
 <h2>Conclusion</h2>
